...
const translations = {
  ...
  "A filter configuration with this name already exists": "A filter configuration with this name already exists",
  "Do you want to overwrite the existing filter configuration?": "Do you want to overwrite the existing filter configuration?",
  "Overwrite": "Overwrite",
