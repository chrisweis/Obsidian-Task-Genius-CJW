...
// Emitters
export const emitSidebarSelectionChanged = (app: App, payload: Omit<SidebarSelectionPayload, "seq">) => {
...
export const emitTaskSelected = (app: App, payload: Omit<TaskSelectionPayload, "seq">) => {
...
// Subscribers
export const onSidebarSelectionChanged = (app: App, handler: (payload: SidebarSelectionPayload) => void): EventRef => {
	return coreOn(app, UIEvents.SIDEBAR_SELECTION_CHANGED, handler);
};

export const onTaskSelected = (app: App, handler: (payload: TaskSelectionPayload) => void): EventRef => {
